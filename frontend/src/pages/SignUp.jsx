    ...
    >
      ...
      >
        ...
        <p className="text-gray-600 mb-8">
          Create account to get started with delicious food deliveries.
        </p>

        {/* implementing fullName form component */}
        <div className="mb-4 ">
          <label
            htmlFor="fullName"
        ...
        {/* implementing mobile form component */}
        <div className="mb-4 ">
          <label
            htmlFor="mobile"
            className="block text-gray-700 font-medium mb-1 "
